...
|-------|---------|-------------|-------------|
| [airbyte](charts/airbyte) | [![Version](https://img.shields.io/badge/dynamic/yaml?url=https%3A%2F%2Feldara-tech.github.io%2Fswarmcli-charts%2Findex.yaml&query=%24.entries.airbyte%5B0%5D.version&label=&color=blue)](https://github.com/Eldara-Tech/swarmcli-charts/releases) | ![App Version](https://img.shields.io/badge/dynamic/yaml?url=https%3A%2F%2Feldara-tech.github.io%2Fswarmcli-charts%2Findex.yaml&query=%24.entries.airbyte%5B0%5D.appVersion&label=&color=informational) | Airbyte data integration platform for Docker Swarm — external PostgreSQL and S3 storage, OIDC-protected, connectors launched through the Docker socket |
...
| [gitlab-runner](charts/gitlab-runner) | [![Version](https://img.shields.io/badge/dynamic/yaml?url=https%3A%2F%2Feldara-tech.github.io%2Fswarmcli-charts%2Findex.yaml&query=%24.entries.gitlab-runner%5B0%5D.version&label=&color=blue)](https://github.com/Eldara-Tech/swarmcli-charts/releases) | ![App Version](https://img.shields.io/badge/dynamic/yaml?url=https%3A%2F%2Feldara-tech.github.io%2Fswarmcli-charts%2Findex.yaml&query=%24.entries.gitlab-runner%5B0%5D.appVersion&label=&color=informational) | GitLab Runner for Docker Swarm — docker executor on the node's own engine, authentication token from a Swarm secret, optional S3 job cache |
...
| [loki](charts/loki) | [![Version](https://img.shields.io/badge/dynamic/yaml?url=https%3A%2F%2Feldara-tech.github.io%2Fswarmcli-charts%2Findex.yaml&query=%24.entries.loki%5B0%5D.version&label=&color=blue)](https://github.com/Eldara-Tech/swarmcli-charts/releases) | ![App Version](https://img.shields.io/badge/dynamic/yaml?url=https%3A%2F%2Feldara-tech.github.io%2Fswarmcli-charts%2Findex.yaml&query=%24.entries.loki%5B0%5D.appVersion&label=&color=informational) | Grafana Loki log aggregation for Docker Swarm — single-binary, filesystem-backed, retention-enforcing, with an opt-in Alloy log shipper |
...
| [mariadb-galera](charts/mariadb-galera) | [![Version](https://img.shields.io/badge/dynamic/yaml?url=https%3A%2F%2Feldara-tech.github.io%2Fswarmcli-charts%2Findex.yaml&query=%24.entries.mariadb-galera%5B0%5D.version&label=&color=blue)](https://github.com/Eldara-Tech/swarmcli-charts/releases) | ![App Version](https://img.shields.io/badge/dynamic/yaml?url=https%3A%2F%2Feldara-tech.github.io%2Fswarmcli-charts%2Findex.yaml&query=%24.entries.mariadb-galera%5B0%5D.appVersion&label=&color=informational) | MariaDB Galera cluster for Docker Swarm — synchronous multi-primary, one pinned peer per node |
| [mongodb](charts/mongodb) | [![Version](https://img.shields.io/badge/dynamic/yaml?url=https%3A%2F%2Feldara-tech.github.io%2Fswarmcli-charts%2Findex.yaml&query=%24.entries.mongodb%5B0%5D.version&label=&color=blue)](https://github.com/Eldara-Tech/swarmcli-charts/releases) | ![App Version](https://img.shields.io/badge/dynamic/yaml?url=https%3A%2F%2Feldara-tech.github.io%2Fswarmcli-charts%2Findex.yaml&query=%24.entries.mongodb%5B0%5D.appVersion&label=&color=informational) | MongoDB document database for Docker Swarm — persistent, secret-authenticated app user, optional single-member replica set |
